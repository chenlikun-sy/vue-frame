...
module.exports = function (grunt) {
    ...
    copy: {
      copyFrame: {
        files: [
          ...
          {
            expand: true,
            src: ["lib/vue/dist/vue.js"],
            dest: "dist",
            filter: "isFile",
          },
          {
            expand: true,
            src: ["lib/require-vuejs/dist/require-vuejs.js"],
            dest: "dist",
            filter: "isFile",
          },
          {
            expand: true,
            src: ["lib/vue-router/dist/vue-router.js"],
            dest: "dist",
            filter: "isFile",
          },
          {
          ...
          {
            expand: true,
            src: ["lib/axios/dist/axios.js"],
            dest: "dist",
            filter: "isFile",
          },
          {
            expand: true,
            src: ["lib/echarts/dist/echarts-all.min.js"],
            dest: "dist",
            filter: "isFile",
          },
          {
            expand: true,
            src: ["lib/d3/dist/d3.js"],
            dest: "dist",
            filter: "isFile",
          },
          {
            expand: true,
            src: ["lib/vuex/dist/vuex.js"],
            dest: "dist",
            filter: "isFile",
          },
          {
            expand: true,
            src: ["lib/vue-i18n/dist/vue-i18n.js"],
            dest: "dist",
            filter: "isFile",
          },
        ],
      ...
      copySrc: {
        files: [
          {
            expand: true,
            src: ["plugin/src/" + product + "/configs/**"],
            dest: "dist/",
          },
          {
            expand: true,
            src: ["plugin/src/" + product + "/files/**"],
            dest: "dist/",
          },
          {
            expand: true,
            src: ["plugin/src/" + product + "/imgs/**"],
            dest: "dist/",
          },
        ],
      },
  ...
  grunt.registerTask("frame", [
    "jshint",
    "clean:dist",
    "vue_split_file:vueSplitFrame",
    "asyncTaskFrame",
  ]);
